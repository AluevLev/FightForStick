namespace UnityIceFebruary.AutoGenerator
{
    ...
    public static class ProxyGenerator
    {
        ...
        public static void Generate()
        {
            ...
            Type[] inGameTypes = Directory.GetFiles(Application.dataPath, "*.cs", SearchOption.AllDirectories)
                .Select(path => Path.GetFileNameWithoutExtension(path))
                .Where(path => !path.EndsWith(AutogeneratedMark))
                .Select(name => Assembly.Load("Assembly-CSharp").GetTypes().FirstOrDefault(type => type.Name == name))
