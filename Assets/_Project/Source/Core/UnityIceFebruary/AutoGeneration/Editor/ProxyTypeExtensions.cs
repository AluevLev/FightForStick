namespace UnityIceFebruary.AutoGenerator
{
    ...
    public static class ProxyTypeExtensions
    {
        ...
        public static string GetProxyName(this Type type) => $"{type.Name.Split('`')[0]}_{ProxyGenerator.AutogeneratedMark}";
        public static bool IsUnityAnalog(this Type type)
        {
            Type baseType = type.BaseType;
            return baseType != null && baseType.IsGenericType && baseType.GetGenericTypeDefinition() == typeof(UnityBaseEntity<>);
        }
