...
public sealed class EntityMotorHandler : IMotorHandler, IFixedFrame
{
    ...
    /*
    public EntityMotorHandler(IDestroyable<IRigidbody2D> pushBody, IOverlapper groundCheck, IMovementCalculator movementCalculator, EntityBoneAnimation boneAnimation)
    {
        _pushBody = pushBody;
